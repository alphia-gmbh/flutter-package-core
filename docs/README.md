...
- Example [index.js](/example/functions/index.js) for [revoking the Sign-in with Apple token](https://developer.apple.com/documentation/signinwithapplerestapi/revoke_tokens) via Cloud Functions
- High-level abstraction for showing snackbars and dialogs
- Monochrome theming system
- And more

## Development

This project is maintained on an **as-needed basis** and follows the pace of our internal work. Updates may be occasional and **breaking changes can happen without prior notice**.
...
[Contact and Legal Notice](https://www.alphia.io/impressum).
